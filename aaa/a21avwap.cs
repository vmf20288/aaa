    ...
    public class a21avwap : Indicator
    {
        ...
        protected override void OnStateChange()
        {
            if (State == State.SetDefaults)
            {
                ...
                Plots[0].DashStyleHelper  = NinjaTrader.Gui.Tools.DashStyleHelper.Dash;
                Plots[1].DashStyleHelper  = NinjaTrader.Gui.Tools.DashStyleHelper.Dash;
                Plots[2].DashStyleHelper  = NinjaTrader.Gui.Tools.DashStyleHelper.Dash;
                Plots[3].DashStyleHelper  = NinjaTrader.Gui.Tools.DashStyleHelper.Dash;
                Plots[4].DashStyleHelper  = NinjaTrader.Gui.Tools.DashStyleHelper.Dash;
                Plots[5].DashStyleHelper  = NinjaTrader.Gui.Tools.DashStyleHelper.Dash;
                Plots[6].DashStyleHelper  = NinjaTrader.Gui.Tools.DashStyleHelper.Dash;
                Plots[7].DashStyleHelper  = NinjaTrader.Gui.Tools.DashStyleHelper.Dash;
                Plots[8].DashStyleHelper  = NinjaTrader.Gui.Tools.DashStyleHelper.Dash;
                Plots[9].DashStyleHelper  = NinjaTrader.Gui.Tools.DashStyleHelper.Dash;
                Plots[10].DashStyleHelper = NinjaTrader.Gui.Tools.DashStyleHelper.Dot;
                Plots[11].DashStyleHelper = NinjaTrader.Gui.Tools.DashStyleHelper.Dot;
                Plots[12].DashStyleHelper = NinjaTrader.Gui.Tools.DashStyleHelper.Dot;
                Plots[13].DashStyleHelper = NinjaTrader.Gui.Tools.DashStyleHelper.Dot;
                Plots[14].DashStyleHelper = NinjaTrader.Gui.Tools.DashStyleHelper.Dot;
                Plots[15].DashStyleHelper = NinjaTrader.Gui.Tools.DashStyleHelper.Solid;
                Plots[16].DashStyleHelper = NinjaTrader.Gui.Tools.DashStyleHelper.Solid;
                Plots[17].DashStyleHelper = NinjaTrader.Gui.Tools.DashStyleHelper.Solid;
                Plots[18].DashStyleHelper = NinjaTrader.Gui.Tools.DashStyleHelper.Solid;
                Plots[19].DashStyleHelper = NinjaTrader.Gui.Tools.DashStyleHelper.Solid;
